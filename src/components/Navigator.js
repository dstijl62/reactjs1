...
import { changeLanguageApp } from "../store/actions"; // ⭐ thêm import
    ...
    return (
      <li className={"sub-menu " + this.getItemClass(link)}>
        <Link
          ...
          onClick={() => {
            if (this.props.action && this.props.changeLanguage) {
              this.props.changeLanguage(this.props.action);
            }
                            ...
                            {menu.subMenus &&
                              menu.subMenus.map((subMenu, subMenuIndex) => (
                                <SubMenuWithRouter
                                  ...
                                  name={subMenu.name}
                                  link={subMenu.link}
                                  action={subMenu.action} // ⭐ thêm dòng này
                                  changeLanguage={this.props.changeLanguage} // ⭐ thêm dòng này
...
const mapDispatchToProps = (dispatch) => {
  return {
    changeLanguage: (lang) => dispatch(changeLanguageApp(lang)),
  };
};
